...
def _estimate_salary(driver: Optional[Driver], team: Team,
    ...
    # Never offer less than series minimum
    series_min = {
        "formula_4":        20000,
        "formula_regional": 50000,
        "formula_3":        120000,
        "formula_2":        300000,
        "formula_1":        1000000,
    }
    return max(estimated, series_min.get(series_id, 20000))
...
def _offer_weights(pos: int, total: int, rounds_done: int, total_rounds: int,
    ...
    """Weights for [step_up, step_down, lateral_better, lateral_worse, fired]."""
    ...
    return [w_up, w_down, w_lat_b, w_lat_w, w_fired]
...
OFFER_TYPE_LABEL = {
    ...
    "fired":          "ATENCAO — SITUACAO CRITICA",
}
