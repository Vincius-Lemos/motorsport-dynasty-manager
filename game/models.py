...
class RaceResult:
    ...
    dnf_reason: str = ""
    points: int = 0
    best_lap_time: float = 0.0   # melhor volta da corrida (segundos)
    gap_to_ahead: float = 0.0    # gap para o piloto à frente
...
class NewsItem:
    year: int
    round_number: int
    category: str      # "race", "contract", "injury", "promotion", "market"
    headline: str
    body: str = ""
